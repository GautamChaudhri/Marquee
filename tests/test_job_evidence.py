"""Job evidence: durable retention, storage confinement, and history survival.

Evidence outlives the thing it describes. Covers evidence surviving deletion of the live
movie, series, season, or episode it referenced, deliberate job purge cascading to owned
evidence, confined log and artifact storage keys, and worker nodes as observation-only
records."""
