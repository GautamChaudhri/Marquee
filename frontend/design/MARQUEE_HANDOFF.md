...
[data-theme='light'] {
	...
	--gold: #b9810c;
	--gold-deep: #9c6c08;
	--gold-soft: rgba(185, 129, 12, 0.13);
	--on-gold: #2a1d02;
	--good: #1f9d57;
	--warn: #b9810c;
	--low: #d2731a;
...
_Generated from `Marquee.dc.html` — the authoritative visual spec. Open that file in a browser for interactive reference._
