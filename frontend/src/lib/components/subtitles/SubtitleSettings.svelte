			...
			<div class="settings-section">
				...
				<div class="setting-row">
					...
					<input
						...
						id="preferred-langs"
						class="str-input"
						bind:value={preferredLanguagesStr}
				...
				<div class="setting-row">
					...
					<input
						...
						class="str-input"
						bind:value={mutationConcurrency}
						min="1"
						step="1"
					/>
				</div>
				<div class="setting-row">
					...
					<input
						...
						class="str-input"
						bind:value={generationConcurrency}
						min="1"
						step="1"
					/>
				</div>
			...
			<div class="settings-section">
				...
				<div class="setting-row">
					...
					<label class="toggle">
						<input
							type="checkbox"
							id="protect-last-full-dialogue-chk"
							bind:checked={protectLastFullDialogue}
						/>
						<span class="toggle-track"></span>
					</label>
				</div>
				...
				<div class="path-inputs">
					<div class="field">
						...
						<input
							...
							placeholder="e.g. /mnt/PLUNDER/Media/Movies"
						/>
					</div>
					<div class="field">
