...
KNOB_GROUPS: list[dict[str, Any]] = [
    ...
    {
        "id": "head",
        "label": "Learned head / feedback",
        "description": "Learned-scorer activation and feedback-loop controls.",
        "knobs": [
            "SCORER",
            "HEAD_MIN_LABELS",
            "HEAD_MIN_MOVIES",
            ...
            "FEEDBACK_NEGATIVES_FROM_OVERRIDES",
...
KNOB_META: dict[str, dict[str, Any]] = {
    ...
    "HEAD_MIN_MOVIES": {"kind": "int", "min": 1, "max": 1000, "step": 1},
    "HEAD_AUTO_RETRAIN": {"kind": "bool"},
